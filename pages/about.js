        ...
        <div className={styles.about_sec}>
            ...
            <div className={styles.about_center}>
                <div className={styles.about_cont}>
                    <div className={styles.abc_img}>
                        <img src="/img/974421.jpg" alt="" />
                    </div>
                    <div className={styles.abc_right}>
                        <h3>ABOUT US</h3>
            ...
            <div className={styles.company_table}>
                ...
                <div className={styles.company_tc}>
                    ...
                    <div className={styles.com_de}>
                        <h3>--- Owing to our expertise, we have been able to offer our customers with a quality-assured range of products in varied specifications. Owing to following reasons, we have been able to outshine others in this highly competitive market :</h3>
                        <h4>--- Why Us?</h4>
                        <ul>
